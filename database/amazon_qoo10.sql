...
CREATE TABLE `amazon_products` (
  ...
  `img_url_main` text DEFAULT NULL,
  `img_url_thumb` text DEFAULT NULL,
  ...
  `exhibit` varchar(191) DEFAULT NULL,
...
CREATE TABLE `qoo_products` (
  ...
  `shipping` varchar(191) DEFAULT NULL,
  `description` text DEFAULT NULL,
  `color` varchar(191) DEFAULT NULL,
  `size` varchar(191) DEFAULT NULL,
  ...
  `exhibit` varchar(191) DEFAULT NULL,
  `reason` varchar(191) DEFAULT NULL,
  `seller_code` varchar(191) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('F9Bb3uPKRPpjxa6os22gInVhWSVF3SusTIEbs0zd', 1, '127.0.0.1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36', '', 1726667952);
...
CREATE TABLE `settings` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `amazon_accesskey` varchar(191) DEFAULT NULL,
  `amazon_secretkey` varchar(191) DEFAULT NULL,
  `amazon_partnertag` varchar(191) DEFAULT NULL,
  `qsm_email` varchar(191) DEFAULT NULL,
  `qsm_password` varchar(191) DEFAULT NULL,
  `qsm_apikey` varchar(191) DEFAULT NULL,
  `multiplier` decimal(10,2) DEFAULT NULL,
  `qoo_maincategory` varchar(191) DEFAULT NULL,
  `qoo_subcategory` varchar(191) DEFAULT NULL,
  `qoo_smallcategory` varchar(191) DEFAULT NULL,
  `exhi_asins` text DEFAULT NULL,
  `ng_asins` text DEFAULT NULL,
  `ng_words` text DEFAULT NULL,
...
(2, 1, 'accesskey', 'secretkey', 'partnertag', 'aliq10.hideki@gmail.com', 'Ukumatiiira1', 'BhiQeRsAhG1CSRXs3hEzdq7i_g_2_c_g_1_eMMcILhpP6q_g_2_VNJs_g_3_', 1.50, 'バッグ・雑貨', 'ストール・マフラー', '300003086', 'B0BLRT8XKY\r\nB00LUGN104\r\nB09JSM6X6Q\r\nB09B3M9DCY\r\nB0928N4M35\r\nB0928NCJVC\r\nB0928MRCNY\r\nB0928M3BG9\r\nB0928LMMHG\r\nB0928LVY8F\r\nB0928HML89\r\nB0928LDT53\r\nB0B6HD438S\r\nB09GK3WPYP\r\nB001DO2XWA\r\nB08B9LJ6YQ\r\nB08B9N4VPS\r\nB07T8ZRDDF\r\nB0BCDXHMGP\r\nB0BPB653ZK\r\nB0876CBNCM\r\nB07MBXPPC9\r\nB018LUF7PS\r\nB075D7BDPX\r\nB09X1DY9VV\r\nB0BRGNBZ5C\r\nB0BXH49KBS\r\nB09VC8393C\r\nB07K3ZLRPL\r\nB0C2W1188T\r\nB0BQZMFQNH\r\nB08TT481SM\r\nB09QLRRB98', 'B001DO2XWA\r\nB0876CBNCM\r\nB0BXH49KBS', 'Amazon\r\nQoo10\r\nAsin', 'super0116.dev@gmail.com', '2024-09-11 05:43:34', '2024-09-18 12:03:53');
...
INSERT INTO `users` (`id`, `_token`, `email`, `email_verified_at`, `password`, `role`, `full_name`, `created_at`, `updated_at`) VALUES
(1, '95sFISBOjoR1hkcTz23jhmsHPBZbmUcOck97lHs7', 'super0116.dev@gmail.com', NULL, '$2y$10$2VY2iGbfuL.v31NQdZiAi.Mvcf84tfJKLXWjuVaLBFW5c7PnG/E9m', 'user', 'SuperDev', '2024-09-11 05:38:03', '2024-09-11 14:38:08');
