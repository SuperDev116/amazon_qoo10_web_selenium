...
<script>
    ...
    var mercari_update_product = <?php echo $mercari_update_data; ?>;
    console.log(mercari_update_product);
    ...
    var datatable = $('.datatable').DataTable({
        ...
        autoConfig: true,
        pageLength: 10,
        ajax: `/mercari/update/list/datatable/${mercari_update_product[0]}/${mercari_update_product[1]}`,
        columns: [{
